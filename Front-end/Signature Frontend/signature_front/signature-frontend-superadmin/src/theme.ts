...
import {M_size} from '@/constant/style/StyleConstant';
import {alpha, InputBase, Stack, styled, Theme} from '@mui/material';
...
export type ICompanyTheme = {
  [k: string]: Theme;
};

export const restTheme: Omit<PaletteOptions, 'Primary'> = {
  Black: {
    main: '#000000',
    dark: '#A9A9A9',
  },
...
light.typography.h1 = {
  fontFamily: 'Poppins:wght@800&display=swap',
  fontSize: M_size.h1 ?? '24px',
...
light.typography.h2 = {
  fontFamily: 'Poppins:wght@500&display=swap',
  fontSize: M_size.h2 ?? '20px',
  // '@media (min-width:600px)': {
  //   fontSize: '1.5rem',
  // },
  // [light.breakpoints.up('md')]: {
...
light.typography.h3 = {
  fontFamily: 'Poppins&display=swap',
};
light.typography.h4 = {
  fontFamily: 'verdana-bold-italic',
  fontSize: M_size.h3 ?? '15px',
  // '@media (min-width:600px)': {
  //   fontSize: '1.5rem',
  // },
  // [light.breakpoints.up('md')]: {
