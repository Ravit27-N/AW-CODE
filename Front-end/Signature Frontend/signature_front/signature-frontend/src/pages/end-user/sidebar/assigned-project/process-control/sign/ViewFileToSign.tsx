...
const ViewFileToSign = (props: IViewFileToSign) => {
  ...
  const [
    validateOtp,
    {isLoading: validateOtpLoading, error, data: validateOtpData, reset},
  ] = useValidateOTPMutation();
  const [signDocument, {isLoading: signDocLoading}] = useSignDocumentMutation();
        ...
        {infoPhoneNumber.totalAttempts >= 3 ? (
          ...
          <>
            <Header
              ...
              storeData={storeData}
              handleToggleOtp={handleToggleOtp}
