...
import {validateRoleSign} from '../common/checkRole';
...
const InvitationPages = () => {
  ...
  const {data, isLoading, isError} = useGetProjectByFlowIdQuery({
    id: id + '?' + queryParameters,
  });
  // /** Link to advance_signature **/
  // React.useEffect(() => {
  //   if (isSuccess && processAdvancedInvitation) {
  //     dispatch(
  //       setSignatureLevels({
  //         ...signatureLevels,
  ...
  //       }),
  //     );
  //     navigate(`${Route.participant.advance.root}/${id}?${queryParameters}`);
  //   }
  // }, [data, isSuccess]);
  /** ==================================== **/
  React.useMemo(() => {
  ...
  return (
    <InvitationLayout>
      ...
      {!isError && (
        <>
          {data?.signatureLevel === KeySignatureLevel.SIMPLE && (
            <Drawer
              PaperProps={{
                style: {
                    ...
                    <Stack
                      ...
                      <Stack width={'100%'} spacing={2}>
                        ...
                        <Stack
                          ...
                          <NGText
                            text={t(
                              Localization('invitation', 'accept-the-terms'),
                            )}
                            onClick={() => {
                              setDesktopChecked(!desktopChecked);
                            }}
...
export default InvitationPages;
