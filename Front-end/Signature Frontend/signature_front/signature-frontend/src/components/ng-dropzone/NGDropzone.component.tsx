...
const NGDropzoneComponent = ({
    ...
    if (proDetailstyle) {
      return (
        <Stack direction="row" gap="24px" alignItems="center">
          ...
          <Stack
            ...
            <NGText text={title} myStyle={{fontWeight: 600, ...titleSx}} />
      ...
      return (
        <Stack
          ...
          <NGText text={title} myStyle={{fontWeight: 800, ...titleSx}} />
          <NGText
            text={supportFormatText}
            myStyle={{
              ...StyleConstant.textSmall,
  ...
  return (
    <Stack
      ...
      <Stack>
        <input {...getInputProps()} />
        {render ? render : handlerProDetailStyle()}
      </Stack>
    </Stack>
  );
};
