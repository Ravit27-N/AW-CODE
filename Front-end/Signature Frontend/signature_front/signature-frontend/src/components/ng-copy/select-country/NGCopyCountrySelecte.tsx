...
export default function NGCopyCountrySelect() {
  const [selectedCountry, setSelectedCountry] =
    React.useState<CountryType | null>(null);
  const defaultValue: any | null = countries.find(
  ...
  return (
    <Autocomplete
      ...
      onChange={(event, newValue) => {
        ...
        if (newValue === null) {
          sessionStorage.setItem('documentCountry', 'fr');
        }
        if (newValue !== null) {
          sessionStorage.setItem(
            'documentCountry',
            newValue.code.toLowerCase(),
          );
        }
      }}
