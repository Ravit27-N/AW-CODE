      ...
      <VStack
        ...
        <Stack
          ...
          <MyRoute
            ...
            title={t(Localization('folder', 'company'))!}
          />
          <MyRoute
            goto={Route.corporate.GROUP}
            listIcon={<NGGroupOfPeople />}
            title={t(Localization('folder', 'users'))!}
          />
          <MyRoute
            goto={Route.corporate.SIGNATURE_PROJECTS}
            listIcon={<NGFolder />}
            title={t(Localization('folder', 'project-signature'))!}
          />
          <MyRoute
            goto={Route.corporate.FILE}
            listIcon={<NGFile />}
            title={t(Localization('folder', 'model-signature'))!}
          />
          {/**  It will be used in future   (sig-544-want-to-remove-it)
           <MyRoute
      ...
      <VStack
        ...
        <Stack
          ...
          <MyRoute
            ...
            listName={
              t(Localization('models-corporate', 'department')) ?? 'Marque'
            }
