...
import {INT_MAX, INT_MIN, UINT_MAX, UUIDv1, UUIDv4} from "../../utils/types";
import {TSTest} from '../../utils/tstester';
import {$uuid} from "../../utils/crypto";
import {FoundationWhiteSpaces} from "../../utils/string_tables";
import {TSDateForm} from "../../utils/tsdatecomp";
import {$decodeBase64, $encodeBase64} from "../../utils/data";
...
export const commonsGroups = TSTest.group("Commons interpretation functions", async (group) => {
    ...
    const SUB = {a: 'a', c: 'c'};
    const DICT_B = {
        a: 'A', d: 'D', e: null, f: undefined, g: function () {
        }, h: [0, 1]
    };
