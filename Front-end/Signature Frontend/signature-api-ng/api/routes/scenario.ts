...
import {ScenarioEntity} from "../../entities/scenario/ScenarioEntity";
import { NO_CONTEXT } from '../../classes/interfaces/DBConstants';

export interface ScenarioParams	{ id:number ; sid:number ; }

function _replyModifiedScenario(api:APIServer, reply:FastifyReply, sessionPublicID:number|string, scenario:ScenarioEntity) {
