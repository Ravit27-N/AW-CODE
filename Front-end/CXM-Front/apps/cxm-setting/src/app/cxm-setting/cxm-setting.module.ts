...
import { CxmSettingRoutingModule } from './cxm-setting-routing.module';
...
@NgModule({
  declarations: [CxmSettingComponent],
  imports: [
    CommonModule,
    FormsModule,
    ...
    CxmSettingRoutingModule,
  ],
  exports: [CxmSettingComponent],
})
export class CxmSettingModule {}
