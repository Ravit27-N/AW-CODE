...
module.exports = {
  ...
  plugins: [
    new ModuleFederationPlugin({
      ...
      exposes: {
        './Module': './apps/cxm-analytics/src/app/cxm-analytics/cxm-analytics.module.ts',
      },
    ...
    rules: [
      {
        test: /\.m?js$/,
        exclude:
          /[\\/]node_modules[\\/](?!(incompatible-module1|incompatible_module_2|some_other_nested_module)[\\/])/,
        use: {
          loader: 'babel-loader',
          options: {
            presets: [
