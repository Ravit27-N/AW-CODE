...
import { appRoute, CampaignConstant, FlowTraceability } from '@cxm-smartflow/template/data-access';
import { TranslateService } from '@ngx-translate/core';
import { UserProfileUtil } from '@cxm-smartflow/shared/data-access/services';

@Component({
  selector: 'cxm-smartflow-sms-success-page',
  templateUrl: './sms-success-page.component.html',
  styleUrls: ['./sms-success-page.component.scss']
})
export class SmsSuccessPageComponent implements OnInit {
  ...
  ngOnInit(): void {
    const isCanCreate = UserProfileUtil.canAccess(CampaignConstant.CXM_CAMPAIGN_SMS, CampaignConstant.CREATE_SMS);
