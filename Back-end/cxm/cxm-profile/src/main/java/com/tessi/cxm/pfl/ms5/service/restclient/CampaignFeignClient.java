...
@FeignClient(FeignClientConstants.CXM_CAMPAIGN)
public interface CampaignFeignClient {

  @DeleteMapping("/api/v1/campaigns/remove")
  Void removeCampaign(
  ...
  default void removeCampaignHandler(List<String> usernames, List<Long> serviceIds,
      String tokenHeader) {
    CampaignFeignClient.this.removeCampaign(usernames, serviceIds, tokenHeader);
  }
}
